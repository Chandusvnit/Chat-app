    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4 text-white">
      <div className="w-full max-w-md space-y-6 rounded-2xl bg-zinc-900 p-8 shadow-xl border border-zinc-800">
        ...
        <div className="flex flex-col items-center space-y-2 text-center">
          ...
          <p className="text-sm text-zinc-400">Get started with your real-time chat workspace</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-medium uppercase tracking-wider text-zinc-400 mb-1.5">Full Name</label>
